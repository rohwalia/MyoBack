...
mean_segments_lc, std_segments_lc = process_time_series_separately(segments_lc, 'lc_aux_dynamic_squat_0kg')
mean_segments_mark, std_segments_mark = compute_and_plot_distances('aux_dynamic_squat_0kg', segments_mark)


common_time = np.linspace(0, 1, 1000) 
exo_forces = np.load("exo_forces_dynamic_squat.npy")[:,0]
